    ...
    <div id="PromoCard" className="promoCard card border-0 overflow-hidden">
      ...
      <div className="card-body d-flex flex-column gap-2">
        ...
        <button
          ...
          onClick={props.onAddCarrinho} //adicionando a açãp de click para + 1 item de jogo no carrinho, não se faz necessário adicionar uma função de callack ou um item interno na função, exemplo onAddCarrinho (jogo)
        >
